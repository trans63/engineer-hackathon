...
(0, _data.addNotifier)('poll', function (poll) {
...
notifier.use('/api/poll', function () {
  return (0, _data.getPolls)();
});
notifier.use('/api/poll/:id', function (param) {
  return (0, _data.getPoll)(param.id).then(function (result) {
